...
from run_poc_single import run_single
...
def run_DTU_POC(args):
    ...
    # scans_dirs = os.listdir(os.path.join(os.getcwd(), 'data', args.dataset_name))
    # args.scans = [int(scan.replace("scan", "")) for scan in scans_dirs]
    # args.scans.sort()
